...
과목 선택 → 학생 명단 입력 → 단원별 등급(매우잘함/잘함/보통/노력요함) 입력 → 평어 자동 생성 → 결과 확인·엑셀 다운로드.
...
3. **/ratings** → 단원별 등급 테이블(행=학생, 열=단원, 매우잘함/잘함/보통/노력요함)
...
- **templates**만 사용: id, grade, semester, subject, unit, level(매우잘함/잘함/보통/노력요함), sentence  
